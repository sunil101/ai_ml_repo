...
class ActionSendEmail(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		if email == None:
			email = "pyemailrasa@gmail.com"
		s = smtplib.SMTP('smtp.gmail.com', 587)
		s.starttls()
		try:
			s.login("pyemailrasa@gmail.com", "python12345678")
		except:
			dispatcher.utter_message("Bad Credentials")
			return [AllSlotsReset()]
		res = "The details of the restaurant you inquired are \n \n "
		res = res + message
		try:
			s.sendmail("pyemailrasa@gmail.com", str(email), res)
			s.quit()
			dispatcher.utter_message("Email Sent, Please check your Inbox")
			return [AllSlotsReset()]
		except:
			dispatcher.utter_message("Email Cannot be Sent")
			return [AllSlotsReset()]
